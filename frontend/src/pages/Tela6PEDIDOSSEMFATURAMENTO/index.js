...
const Tela6PEDIDOSSEMFATURAMENTOPage = () => {
        ...
        <Column className="items-center justify-end w-[100%]">
          <Row className="bg-indigo_700 items-center p-[2px] w-[100%]">
            <Row className="items-end lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] mt-[1px] w-[97%]">
              ...
              <Row className="items-start justify-center lg:mb-[19px] xl:mb-[24px] 2xl:mb-[28px] 3xl:mb-[33px] lg:ml-[44px] xl:ml-[56px] 2xl:ml-[63px] 3xl:ml-[75px] lg:mt-[17px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] w-[11%]">
                <Text
                  className="common-pointer mt-[3px] menu"
                  as="h2"
                  variant="h2"
                ...
                <Stack className="lg:h-[471px] xl:h-[589px] 2xl:h-[663px] 3xl:h-[795px] xl:mb-[10px] 2xl:mb-[12px] 3xl:mb-[14px] lg:mb-[8px] lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] lg:pr-[34px] xl:pr-[43px] 2xl:pr-[49px] 3xl:pr-[58px] rounded-radius4 w-[100%]">
                  ...
                  <Column className="absolute items-center justify-start left-[2%] top-[3%] w-[89%]">
                    <Row className="items-center justify-between w-[96%]">
                      ...
                      <Button
                        className="font-medium mb-[1px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center text-gray_600 w-[54%]"
                        variant="OutlineBluegray400"
                      >
                        informe o código do pedido ou a status
                      </Button>
                      <Button
                    ...
                    <Row className="bg-indigo_700 items-start 3xl:mt-[114px] lg:mt-[67px] xl:mt-[84px] 2xl:mt-[95px] lg:p-[4px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[8px] rounded-radius4 w-[99%]">
                      ...
                      <Text
                        className="lg:mb-[3px] xl:mb-[4px] 2xl:mb-[5px] 3xl:mb-[6px] xl:ml-[112px] 2xl:ml-[126px] 3xl:ml-[151px] lg:ml-[89px] text-white_A700 w-[auto]"
                        as="h4"
                        variant="h4"
                      >
                        STATUS
                    ...
                    <Row className="items-center justify-between lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[97%]">
                      <Column className="items-center rounded-radius4 w-[13%]">
                        <Text className="columndate" as="h3" variant="h3">
                          16/08/2021
                        </Text>
                        <Text
                          className="lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] columndate"
                          as="h3"
                          variant="h3"
                        >
                          16/08/2021
                      ...
                      <List
                        className="gap-[0] min-h-[auto] w-[81%]"
                      ...
                      >
                        <Row className="items-center justify-between 2xl:my-[11px] 3xl:my-[13px] lg:my-[7px] xl:my-[9px] w-[100%]">
                          ...
                          <Row className="items-center justify-between lg:pr-[16px] xl:pr-[20px] 2xl:pr-[23px] 3xl:pr-[27px] rounded-radius4 w-[42%]">
                            <Text
                              className="rowgroupfive_one"
                              as="h3"
                              variant="h3"
                            >
                              0000000
                            ...
                            <Button
                              className="font-medium xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center text-gray_600 w-[58%]"
                              variant="OutlineBluegray400"
                            >
                              CANCELADO
                            </Button>
...
export default Tela6PEDIDOSSEMFATURAMENTOPage;
